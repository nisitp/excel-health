...
//                        $link = "#modal_".$post->ID;
    ...
    ?>
        <div class="resource-teaser resource-post">
            <h3 class="resource-type"><?php print $type; ?></h3>
            ...
            <?php if (!$img) $img = esc_attr(get_field('resource_image', $post->ID));
                ...
                ?>
                <div <?php print $imgstyle;?> class="resource-image-placeholder <?php print $imgclass;?>"> <a class="<?php print esc_attr($linkClass); ?>" href="<?php print esc_attr($link); ?>"><?php print $post->post_title;?></a></div>
